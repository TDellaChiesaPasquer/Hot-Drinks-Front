		...
		return (
			...
			>
				...
				<View style={styles.message}>
					<Text style={styles.username}>{name.length > 25 ? name.slice(0, 22) + "..." : name}</Text>
					<Text style={styles.messageInfo}>
						Dernier message, le {dayjs(lastMessage.date).format("DD/MM/YYYY")} à {dayjs(lastMessage.date).format("HH:mm")}
					</Text>
