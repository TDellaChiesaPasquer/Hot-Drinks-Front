import { StyleSheet, Modal, TextInput, View, Pressable, Text, TouchableOpacity, Dimensions } from "react-native";
...
export default function RdvScreen({ navigation, route }) {
	...
	const rdv = user.user ? user.user.rdvList.find((x) => String(x._id) === String(route.params._id)) : null;
	if (!rdv) {
		return null;
	}
